package gg.steve.mc.tp.libs.savagefactions;
...
public class SavageFactionsLib extends ToolsPlusLib {
    
    public SavageFactionsLib() {
        super(ToolsPlusLibType.SAVAGE_FACTIONS);
    }
